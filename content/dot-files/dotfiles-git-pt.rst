...
Como poupar tempo com gitconfig
*******************************

Aqui partilho o conteudo do meu **~/.gitconfig**

Isto serve para usar diferentes configurações de git dependendo da localização
do repositório que se está a trabalhar.

Isto previne que faça commit de mensagens com o e-mail errado, assim como
permite que alguns repositórios executem comandos de ``pre-commit`` para
garantir que não se está a fazer commit de coisas erradas.
...
E aqui está o conteúdo do meu gitconfig pessoal **~/.gitconfig-personal**
...
E aqui o profissional **~/.gitconfig-work**
...
Estou a utilizar a mesma chave GPG para ambos os mails
